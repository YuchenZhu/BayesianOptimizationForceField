...
# variables
##########################################################################
config = {"ci":"Na", "ai":ele, "Nci":Nci, "Nai":Nai, "extent":ex, "target":0.85e-9,
    "p0" : p0}
...
def makeFiles( sg ):
    ...
    #ff
    FF  = read_ff_vary('/stokes/yuchen/PyMD/FORCEFIELDS/JC/TIP4P2005_q%i'%q, config['ai'], 10**ep, sg, bonded=True)
...
for sg in np.linspace(ex[0], ex[1], 6):
    makeFiles(sg)
